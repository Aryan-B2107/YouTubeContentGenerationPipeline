...
"""
OKAY.. SHIT, so youtube transcript API doesn't work anymore
and I wasted two days for this shit.
...
which is still faster ngl

ALSO:
Many requests can cause IP bans, so this method is generally risky

Though we can work around using multiple proxy servers.
